...
import rnh.mores.entities.renderer.StoneSignTileEntityRenderer;
...
public class Main
{
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        ClientRegistry.bindTileEntityRenderer(TileEntityInit.STONE_SIGN.get(), StoneSignTileEntityRenderer::new);
    }
    ...
    public static class MainBlockGroup extends ItemGroup{
    	   
    	public static final MainBlockGroup instance = new MainBlockGroup(ItemGroup.GROUPS.length,"blocktab");
    	
    	private MainBlockGroup(int index, String label) {
    		super(index, label);
    	}
    		@Override
    		public ItemStack createIcon() {
    			return new ItemStack(BlockInit.granite_cobblestone_block);
    	}
    }
}